...
class AMEGNN(nn.Module):
    ...
    def forward(self, h, x, edges, channel_attr, channel_weights, ctx_edge_attr=None, x_update_mask=None, edge_bias=None, edge_gate=None):
        h = self.linear_in(h)
        h = self.dropout(h)
...
class AM_E_GCL(nn.Module):
    ...
    def edge_model(self, source, target, radial, edge_attr, edge_bias=None, edge_gate=None):
        '''
    ...
    def forward(self, h, edge_index, coord, channel_attr, channel_weights,
                edge_attr=None, node_attr=None, x_update_mask=None, edge_bias=None, edge_gate=None):
        '''
        ...
        edge_feat = self.edge_model(h[row], h[col], radial, edge_attr, edge_bias=edge_bias, edge_gate=edge_gate)  # [n_edge, hidden_size]
