...
def parse():
    parser = argparse.ArgumentParser(description='run apcyc for codesign or structure prediction')
    ...
    parser.add_argument('--ckpt', type=str, default=None, help='Checkpoint path. Defaults to checkpoints/{codesign,fixseq}.ckpt')
...
if __name__ == '__main__':
    ...
    if not os.path.exists(ckpt):
        raise FileNotFoundError(f'Checkpoint not found: {ckpt}. Please pass --ckpt or place weights under checkpoints/.')
